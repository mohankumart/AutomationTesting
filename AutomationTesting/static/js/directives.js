...
directives.directive('utPanelSet',function(){
	return {
	    ...
	    template: '<div class="divTable" ng-transclude></div>',
...
directives.directive('utPanelHeading',function(){
	return {
		...
		replace: true,
		require: '^utPanelSet',
		template: '<div class="utTableHeading">'+
				  '	<div class="utTableHead" ng-style="setHeadStyles(col, $index)" ng-repeat="col in config">{{col.columnName}}</div>'+
				  '</div>',
		scope: {
		},
...
directives.directive('utPanel',function(){
	return {
		...
		replace: true,
		require: '^utPanelSet',
		template: '<div class="utTableRow">'+
					'<div class="utTableCell" ng-repeat="col in config" ng-switch="col.map" ng-click="toggleCollapse()">'+
